    ...
    <section className="relative overflow-hidden bg-background">
      ...
      >
        <CarouselContent>
          ...
          {/* SLIDE 2: B2B / Wholesale Promotion */}
          <CarouselItem>
            <div className="relative overflow-hidden w-full h-[500px] md:h-[600px] flex items-center">
              ...
              <div className="container-tight relative z-10 w-full py-16 md:py-24 text-left">
                <div className="max-w-2xl">
                  {/* B2B Badge aligned to original styles */}
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 text-white border border-white/20 text-sm font-medium mb-6 backdrop-blur-md shadow-lg">
                    🏢 B2B / Wholesale
                  </div>
          ...
          {/* SLIDE 3: Promotional Offer Banner (₹1 Ad) */}
          <CarouselItem>
            <div className="relative overflow-hidden w-full h-[500px] md:h-[600px] flex items-center">
